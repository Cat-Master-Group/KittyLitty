    ...
    const requestConfig = {
      ...
      data: {
        ...
        userCat: {
          ...
          catAge:
            parseInt(
              filterXSS(document.getElementById("signup-cat-age-years").value)
            ) +
            parseInt(
              filterXSS(document.getElementById("signup-cat-age-months").value)
            ),
          catBreed: filterXSS(
            document.getElementById("signup-cat-breed").value
          ),
          catIsAltered:
            filterXSS(document.getElementById("signup-cat-altered").value) ===
            "true",
          catGallery: [
            filterXSS(document.getElementById("signup-cat-image").value),
          ],
        },
